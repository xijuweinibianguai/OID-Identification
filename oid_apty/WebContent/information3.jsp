...
<body>
		...
		<div id="containter">
			...
			<div id="content">
				<div id="main">
					<div class="up"></div>
					<div class="t"></div>
					<div class="left" style="background:url(images/node.jpg)">
		...
		<table  style=" width: 100%; border-collapse: collapse; border-spacing: 0;" >
			<tr>
				<td colspan="3" style="text-align: center;padding: 8px; width:100%;line-height: 20px;background-color: #169fe6; display: table-cell;">OID为：<%String name = request.getParameter("node_oid");%><%=name %>的传感节点应用属性信息</td>
